...
function clickSetLoading(){
  ...
  if ($("div").hasClass("overlay") === true) {
      ...
      html +=   '<div id="loading" class="left" >'+
          ...
          '<img class="left-img" src="../FrontWeb/Images/word_excel_img.png">'+
          ' </div>'+
          '<div id="loading" class="right">'+
          '<p>단어, 의미가 연결된 텍스트 데이터</p>'+
          '<img class="right-img" src="../FrontWeb/Images/word_text_img.png">'+
          '</div>'+
          '</div>';
...
function clickSetLeftLoading(){
  ...
  '<div id="left-loading" class="right" >'+
    '<img src="../FrontWeb/Images/word_excel_img.png">'+
  '</div>';
      ...
      '<div class="extract-container">'+
        ...
        '<div id=extract class="bottom-container">'+
          ...
          '<div id=extract class="right">'+
            '<img src="../FrontWeb/Images/extractword.png">'+
          '</div>'+
      '</div>'+
