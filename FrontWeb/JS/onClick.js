...
function clickMyClass() { // 나의 클래스로 이동
  location.href = "../Pages/myClass.html";
}
...
function clickSearchSet() { // 세트 검색으로 이동
  location.href = "../Pages/setSearchPageElementary.html";
}
...
function clickMainPageTeacher() { // 로그인 시 선생님 메인페이지로 이동
  location.href = "../Pages/signedUpMainPage-teacher.html";
}
...
function clickMyClassStudent() {
  location.href = "../Pages/myClass-student.html";
}

function clickReport() {
  location.href = "../Pages/classToReport.html";
}

function clickStudentVoca() {
  location.href = "../Pages/studentVocaMain.html";
}
